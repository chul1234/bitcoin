...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 테마 메타데이터
    const themeMeta = {
        'VALUE': { title: '💎 저가 매수 (고잠재력)', desc: '저평가 코인 분할 매수 (첫 20%, 추가 5%, 대기 40분, 익절 +15%, 손절 -8%)', color: '#10B981', bg: 'rgba(16, 185, 129, 0.1)' },
        'HIGH_RISK': { title: '🔥 고위험 / 고수익', desc: '단기 펌핑 극강 변동성 (첫 25%, 추가 5%, 대기 10분, 익절 +20%, 손절 -10%)', color: '#EF4444', bg: 'rgba(239, 68, 68, 0.1)' },
        'SAFE': { title: '🛡️ 우량 안전 자산', desc: '안전제일 짧은 수익 (첫 10%, 추가 2%, 대기 30분, 익절 +5%, 손절 -3%)', color: '#3B82F6', bg: 'rgba(59, 130, 246, 0.1)' },
        'TRENDING': { title: '🚀 트렌딩 내러티브', desc: '시장 주도주 추세 추종 (첫 15%, 추가 4%, 대기 20분, 익절 +10%, 손절 -5%)', color: '#F59E0B', bg: 'rgba(245, 158, 11, 0.1)' }
    };
